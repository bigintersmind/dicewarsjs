...
- **Tilt the dice your way** — an optional luck handicap on a second axis: Normal, Lucky, or Very lucky, where your seat rolls extra dice and drops the lowest, attacking and defending
...
>
> Alongside the ladder sits a second, independent axis — **your luck** (#179), picked per game on the title screen: **Normal** (fair dice), **Lucky**, or **Very lucky**, where your seat rolls one or two extra dice and drops the lowest, both attacking and defending. It is the way to keep the sophisticated Hard opponents and still win; the kept dice are the ones the animation shows, ties still go to the defender, and it is recorded in the replay. It is always off for AI-vs-AI games and on every competitive surface — see [docs/GAME_RULES.md](docs/GAME_RULES.md#luck-handicap-advantage-dice).
>
