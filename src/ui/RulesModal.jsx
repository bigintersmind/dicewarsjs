...
export const RULES_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Keyboard: the arrow keys move between territories, Enter or Space picks the one in focus, and E ends your turn. Tab steps through your own territories and past the last one reaches END TURN.',
    ],
  },
];
