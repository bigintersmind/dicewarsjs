...
async function main() {
  ...
  /*
   * Coaching is gated on a preference, so toggling it mid-game has to reach the
   * board immediately — the controller only recomputes at its own game-loop
   * seams, none of which a settings click passes through.
   */
  preferencesManager.subscribe(() => controller.refreshCoachHighlights());
