...
> **Status:** Active — press-mechanism landed (D-9): `ai_expectimax` now **ties `ai_lookahead`** (joint-strongest — win% dead-heat, significantly out-places it, ELO co-leader, 1v1 tie). The Phase 0 headline gate (a _significant win% edge_ over Lookahead) is still **open** — parity, not a win. Next: Track B (learned policy) or an eval rework.
...
| ----: | ------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     0 | Quick-win search bot                  | 🟨 Shipped; gate open (tie) | **Press-mechanism landed (D-9):** posture-adaptive threshold + elimination term + low-odds risk floor. `ai_expectimax` now **ties `ai_lookahead`** (16,800 seat-fair games: win% 22–23% vs 22.5–23.9%; **significantly out-places it**, paired 51.2%, p≈0.002; ELO co-leader; 1v1 tie). Beats Strategist (13–14%). Rank 6/7 → **joint-strongest**. Headline gate (sig. **win%** edge over Lookahead) still **open** — it's a tie. Next: Track B / eval rework. |
