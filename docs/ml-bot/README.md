...
|     4 | Ship the strongest bot                | 🟨 In progress              | Winner wired as in-browser bot + in tournament pool. **`ai_ppo` is already wired (PR #74) and decoupled from its weights;** this PR swaps in the BEAT-gated 20M weights (`ppoPolicyWeights.js`, `f6be9b91…` replacing task-A `1a754eef…`) with no code change → the in-game AI picker (difficulty 5) + the daily tournament/leaderboard now run the strongest PPO bot. Remaining: merge + confirm the tournament picks it up.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
