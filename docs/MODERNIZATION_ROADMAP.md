...
6. [Phase 1: Foundation](#6-phase-1-foundation--complete)
7. [Phase 2: Core game engine](#7-phase-2-core-game-engine--complete)
8. [Phase 3: Rendering & UI](#8-phase-3-rendering--ui--complete)
